...
export const ChartsRow: React.FC<ChartsRowProps> = ({ stats }) => (
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    {/* Type Distribution */}
    <div className="bg-surface border border-zinc-700 p-4 md:p-6 rounded-2xl shadow-lg overflow-hidden">
            ...
            return (
              <div key={type}>
                <div className="flex justify-between text-sm mb-1.5">
                  ...
                  <span className="text-zinc-500 font-mono">{numCount}</span>
                </div>
    ...
    {/* Rating Distribution */}
    <div className="bg-surface border border-zinc-700 p-4 md:p-6 rounded-2xl shadow-lg flex flex-col overflow-hidden">
      <div className="flex items-center justify-between mb-6">
        ...
        {stats.highestRatedGenre !== "N/A" && (
          <span className="text-[10px] bg-zinc-800 text-yellow-400 border border-yellow-400/30 px-2 py-1 rounded-md">
